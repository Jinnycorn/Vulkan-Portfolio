...
if(EXISTS "C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-subbuild/glfw-populate-prefix/src/glfw-populate-stamp/glfw-populate-gitclone-lastrun.txt" AND EXISTS "C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-subbuild/glfw-populate-prefix/src/glfw-populate-stamp/glfw-populate-gitinfo.txt" AND
  ...
  message(VERBOSE
    ...
    "'C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-subbuild/glfw-populate-prefix/src/glfw-populate-stamp/glfw-populate-gitclone-lastrun.txt'"
  )
  return()
endif()
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: 'C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-src'")
endif()
...
while(error_code AND number_of_tries LESS ${max_tries})
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps"
    RESULT_VARIABLE error_code
    ${maybe_show_command}
  )
...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe"
          checkout "3.4" --
  WORKING_DIRECTORY "C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: 'C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: 'C:/Users/ehgam/Documents/Vulkan-Portfolio/_build-basic/_deps/glfw-subbuild/glfw-populate-prefix/src/glfw-populate-stamp/glfw-populate-gitclone-lastrun.txt'")
endif()
